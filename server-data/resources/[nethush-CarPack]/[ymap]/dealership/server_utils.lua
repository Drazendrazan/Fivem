...
function insertVehicleOnGarage(source,vehicleProps,vehicle_model)
	...
	MySQL.Async.execute('INSERT INTO player_vehicles (steam, citizenid, plate, vehicle, mods, state, metadata, garage) VALUES (@steam, @citizenid, @plate, @vehicle, @mods, @state, @metadata, @garage)',
	{
		['@steam']   = xPlayer.PlayerData.steam,
