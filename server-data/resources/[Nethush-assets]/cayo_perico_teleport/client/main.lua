...
Citizen.CreateThread(
  function()
    local waitTime = 500
    AddTextEntry("DOPE_PERICO_HELP", "Appuyer sur ~a~ pour aller à ~a~")
    CreateNewBlips()
    while true do
      Wait(waitTime)
...
RegisterKeyMapping("+dope_perico", "Téléportation vers / depuis Cayo Perico", "keyboard", Config.Control.Key)
