...
Config.CircleZones = {
	WeedField = {coords = vector3(5209.11, -5203.67, 15.65), name = 'blip_weedfield', color = 25, sprite = 496, radius = 100.0},
	WeedProcessing = {coords = vector3(5196.11, -5133.53, 3.36), name = 'blip_weedprocessing', color = 25, sprite = 496, radius = 100.0},
