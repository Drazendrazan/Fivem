...
AddEventHandler('xd_drugs_weed:pickedUpCannabis2', function()
	...
	local Player = QBCore.Functions.GetPlayer(src)
	    ...
	    if 	TriggerClientEvent("QBCore:Notify", src, "Picked up some coke.", "Success", 8000) then
		  ...
		  TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['cocke'], "add")
	    end
end)
...
AddEventHandler('xd_drugs_weed:processweed2', function()
	...
	if Player.Functions.GetItemByName('cocke') and Player.Functions.GetItemByName('empty_plastic_bag') then
		...
		-- if chance == 1 or chance == 2 or chance == 3 or chance == 4 or chance == 5 or chance == 6 or chance == 7 or chance == 8 then
			...
			TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['cocke'], "remove")
			TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['empty_plastic_bag'], "remove")
			TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['bag_cocke'], "add")
...
AddEventHandler('xd_drugs_weed:selld2', function()
	...
	if Player.Functions.GetItemByName('bag_cocke') then
		...
		if chance2 == 1 or chance2 == 2 or chance2 == 9 or chance2 == 4 or chance2 == 10 or chance2 == 6 or chance2 == 7 or chance2 == 8 then
			...
			TriggerClientEvent("inventory:client:ItemBox", source, QBCore.Shared.Items['bag_cocke'], "remove")
