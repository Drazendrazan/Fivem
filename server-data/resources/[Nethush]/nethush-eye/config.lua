...
Config.ObjectOptions = {
    ...
    [GetHashKey('prop_till_01')] = {
        [1] = {
            ...
            ['EventName'] = 'nethush-stores:server:open:shop',
        },
    },
    ...
    [1746653202] = {
        [1] = {
            ...
            ['EventType'] = 'Client',
            ['Logo'] = '<i class="fas fa-comments"></i>',
            ['EventName'] = 'nethush-illegal:client:talk:to:npc',
        },
    },
    [2023152276] = {
        [1] = {
    ...
    [GetHashKey('prop_vend_coffe_01')] = {
        [1] = {
            ...
            ['EventName'] = 'nethush-stores:client:open:custom:store',
...
Config.PedMenu = {
    [1] = {
        ...
        ['EventName'] = 'nethush-illegal:client:sell:to:ped',
    }, 
}
