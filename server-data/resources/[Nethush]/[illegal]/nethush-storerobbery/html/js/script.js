...
StoreRob.Functions.ClosePinpad = function(HasPutin) {
    ...
    $.post('http://nethush-storerobbery/PinpadClose', JSON.stringify({
...
$(document).on('keydown', function() {
    switch(event.keyCode) {
        ...
        case 13:
            var v = $("#PINbox").val();
            if (v == "") {
                $.post('http://nethush-storerobbery/ClickFail', JSON.stringify({}))
                $.post('http://nethush-storerobbery/ErrorMessage', JSON.stringify({
                ...
                $("#PINbox").val("");
                $.post('http://nethush-storerobbery/Click', JSON.stringify({}))
                $.post('http://nethush-storerobbery/EnterPincode', JSON.stringify({
                    pin: data.pin
                }))
