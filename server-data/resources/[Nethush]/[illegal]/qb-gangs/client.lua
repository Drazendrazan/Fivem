local menuActive, currentCID, currentGang, currentLocation, QBCore, Settings = false;
...
RegisterNetEvent("gangs:openmenu")
AddEventHandler("gangs:openmenu", function()
...
AddEventHandler("gangs:openStash", function(gang)
    TriggerServerEvent("nethush-inventory:server:OpenInventory", "stash", gang, {
        maxweight = 4000000,
        slots = 500,
    })
    TriggerEvent("nethush-inventory:client:SetCurrentStash", gang)
end)
