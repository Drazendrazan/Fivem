...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function()
 Citizen.SetTimeout(450, function()
  ...
  Citizen.Wait(250)
  QBCore.Functions.TriggerCallback("qb-dealers:server:get:config", function(config)
...
AddEventHandler('qb-dealers:client:open:dealer', function()
    Citizen.SetTimeout(350, function()
        ...
        if CurrentDealer ~= nil then 
          ...
          TriggerServerEvent("nethush-inventory:server:OpenInventory", "shop", "Dealer_"..CurrentDealer, Shop)
        end
    end)
end)
