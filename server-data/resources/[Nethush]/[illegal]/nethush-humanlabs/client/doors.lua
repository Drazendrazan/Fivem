...
RegisterNetEvent('nethush-humanlabs:client:ClearTimeoutDoors')
AddEventHandler('nethush-humanlabs:client:ClearTimeoutDoors', function()
    TriggerServerEvent('nethush-doorlock:server:updateState', 121, true)
