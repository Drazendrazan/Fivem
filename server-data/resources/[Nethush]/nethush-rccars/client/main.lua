...
RegisterCommand("rc", function()
	...
	if (hasRc) then
		...
		TriggerEvent('swt_notifications:Infos','You don\'t have the RC car!!')
	end
	
end)
-------------------------------------------------------------------------------------------------------------------------------------

----------------------------------USABLE ITEM CLIENT SIDE--------------------------------------------------------------------------
RegisterNetEvent('coderc_rc:RonEat')
AddEventHandler('coderc_rc:RonEat', function()
...
DrawScreenText = function(text)
    ...
    DrawText(0.90 - 1.0/2, 0.52 - 1.0/2 + 0.005)
end
