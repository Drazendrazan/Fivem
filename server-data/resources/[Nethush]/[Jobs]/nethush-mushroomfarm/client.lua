                ...
                if coordonate[i] ~= nil then
                    if metrii2 <=3 then
                        ...
                        if IsControlJustPressed(1,51) then
                            ...
                            exports['swt_notifications']:Success("SLMC System","1 Mushroom added","top-right",6000,true)
        ...
        if metrii <= 3 then
            ...
            if IsControlJustPressed(1,51) then
                ...
                elseif hasjob == true then
                    exports['swt_notifications']:Info("SLMC System","You have already been hired as a Mushroom Farmer.","top-right",6000,true)
            ...
            elseif IsControlJustPressed(1,246) then
                ...
                DeleteEntity(cosdeoua)
                    ...
                    exports['swt_notifications']:Info("SLMC System","Keep Looking.","top-right",6000,true)
