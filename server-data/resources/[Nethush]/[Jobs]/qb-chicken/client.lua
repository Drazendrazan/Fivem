...
if share == true then
	...
	andsplashed = 0
	share = false
	TriggerEvent("swt_notifications:Infos","Take Alived Chiken To Process Area ..", "primary")
...
function hewassplashed()
	...
	if chanceofsplashes <= 60 then
			TriggerEvent("swt_notifications:Infos","You managed to catch 1 chicken!")
			if Caught1 == 1 then
		...
		TriggerEvent("swt_notifications:Infos","The chicken escaped your arms!")
	end
end
...
function packingg(stanowisko)
	...
	QBCore.Functions.TriggerCallback('QBCore:HasItem', function(result)
		if result then
			...
			TriggerEvent("swt_notifications:Infos","Keep packing the chicken or go to the vehicle and store it.", "primary")
		...
		TriggerEvent("swt_notifications:Infos","You have nothing to pack!")
		end
...
function packed(stanowisko)
	...
	LoadDict('anim@heists@box_carry@')
		...
		TriggerEvent("swt_notifications:Infos","You stopped packing!")
...
function portioning(position)
	...
	QBCore.Functions.TriggerCallback('QBCore:HasItem', function(result)
		if result then
			...
			TriggerEvent("swt_notifications:Infos","Now Pack slaughtered chicken!", "primary")
			...
			TriggerEvent("swt_notifications:Infos","You dont have any chickens!")
		end
	end, 'alivechicken')
end
...
function packedsell()
	...
	QBCore.Functions.TriggerCallback('QBCore:HasItem', function(result)
		if result then
			...
			TriggerEvent("swt_notifications:Infos","You have nothing to sell!")
		end
