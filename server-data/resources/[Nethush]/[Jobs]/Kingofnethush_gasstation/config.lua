...
Config.QBCore = {									-- ESX settings, if you are using vRP just ignore
	['QBCoreSHAREDOBJECT'] = "QBCore:GetObject",-- Change your getshared object event here, if you are using anti-cheat
	['account_stores'] = 'bank',				-- Change here the account that should be used with gas station expenses
}

Config.format = {
	['currency'] = 'LKR',						-- This is the currency format, so that your currency symbol appears correctly [Examples: BRL, USD]
...
Config.max_stations_per_player = 5				-- Maximum number of stores that each player can have
	...
	['small_gas_station'] = {					-- Gas station type ID
		...
		['ressuply'] = {								-- Definition of contracts for the owner
			[1] = {
				...
				['price_per_liter_to_import'] = 5,		-- Price per liter to import
				['price_per_liter_to_export'] = 20,		-- Price per liter to export
			...
			[2] = {
				['name'] = 'Medium cargo',
				['price_per_liter_to_import'] = 7,
				['price_per_liter_to_export'] = 20,
				['liters'] = 100,
				['max_distance'] = 5.5,
				['truck_level'] = 2,
				['img'] = 'barril.png'
