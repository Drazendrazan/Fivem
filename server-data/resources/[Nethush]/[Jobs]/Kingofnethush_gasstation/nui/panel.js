		...
		$('#upgrades-page').append(`
			<div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
				<div class="card rounded shadow-sm border-0">
					<div class="card-body p-4"><img src="https://media.discordapp.net/attachments/874857658346274856/898033867779366912/Mini_City_Role_Play.png" alt="" class="img-fluid d-block mx-auto mb-3">
...
function post(name,data){
	$.post("http://Kingofnethush_gasstation/"+name,JSON.stringify(data),function(datab){
		if (datab != "ok"){
			console.log(datab);
		}
	});
