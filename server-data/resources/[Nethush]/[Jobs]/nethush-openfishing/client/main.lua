...
RegisterNetEvent("nethush-openfishing:tryToFish")
AddEventHandler("nethush-openfishing:tryToFish", function()
	TryToFish() 
end)

RegisterNetEvent("nethush-openfishing:calculatedistances")
AddEventHandler("nethush-openfishing:calculatedistances", pos, function()
