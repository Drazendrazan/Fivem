...
AddEventHandler('qb-tow:server:DoBail', function(bool, vehInfo)
    ...
    if bool then
        if Player.PlayerData.money.cash >= Config.BailPrice then
            ...
            TriggerClientEvent('swt_notifications:Infos', src, 'You paid your deposit of 1000,- ')
        ...
        if Bail[Player.PlayerData.citizenid] ~= nil then
            ...
            TriggerClientEvent('swt_notifications:Infos', src, 'You have received your deporit of 1000,- back')
        end
    end
end)
