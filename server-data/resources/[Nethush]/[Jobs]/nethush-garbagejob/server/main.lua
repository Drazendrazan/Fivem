...
AddEventHandler('qb-garbagejob:server:Pay', function(amount, location)
    ...
    if amount > 0 then
        ...
        if location == #Config.Locations["vuilnisbakken"] then
            ...
            TriggerClientEvent('swt_notifications:Infos', src, "Congratulations with your new job as "..amount.."")
        end
    else
        TriggerClientEvent('swt_notifications:Infos', src, "You haven't earned anything..")
    end
end)