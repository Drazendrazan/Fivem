...
Config.Locations = {
    ...
    ["vuilnisbakken"] ={
        [1] = {
            name = "forumdrive",
            coords = {x = -242.9301, y = -1473.644, z = 31.473169, h = 3.6300528},
        },
        [2] = {
            name = "grovestreet",
            coords = {x = 191.89332 , y = -1730.597, z = 29.291757, h = 301.75454},
        },
        [3] = {
        ...
        [22] = {
            name = "motelstreet",
            coords = {x = 357.88619, y = -1810.484, z = 28.965719, h = 180.70762},
        },
    },
}
