...
RegisterNetEvent('nethush-materials:client:search:trash')
AddEventHandler('nethush-materials:client:search:trash', function()
    if CurrentBin ~= nil then
      if not Config.OpenedBins[CurrentBin] then
        QBCore.Functions.Progressbar("search-trash", "Searching..", math.random(10000, 12500), false, true, {
            ...
            QBCore.Functions.TriggerCallback('nethush-materials:server:get:reward', function() end)
        ...
        TriggerEvent("swt_notifications:Infos","You have already searched this bin..")
      end
    end
end)
