...
Citizen.CreateThread( function()
    ...
    function handleMovement(xVect,yVect)
        if ( IsControlJustPressed( 1, changeSpeedKey ) or IsDisabledControlJustPressed( 1, changeSpeedKey ) ) then
         ...
         --   TriggerEvent("swt_notifications:Infos",Current speed: ".. speeds[travelSpeed])
            TriggerEvent("swt_notifications:Info","SLMC System","Current speed: ".. speeds[travelSpeed],"top-right",5000,true)
