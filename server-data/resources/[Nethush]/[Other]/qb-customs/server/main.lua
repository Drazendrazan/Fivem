...
QBCore.Functions.CreateCallback('qb-customs:server:UpdateBusyState', function(source, cb, k, bool)
...
QBCore.Functions.CreateCallback('qb-customs:server:SaveVehicleProps', function(source, cb, vehicleProps)
	local src = source
