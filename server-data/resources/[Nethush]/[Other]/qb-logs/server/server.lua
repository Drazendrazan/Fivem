...
local loggingApi = "https://cdn.discordapp.com/attachments/954781623323357215/974505674430119986/32-512.png"
...
AddEventHandler('qb-log:server:CreateLog', function(name, title, color, message, tagEveryone)
    ...
    PerformHttpRequest(webHook, function(err, text, headers) end, 'POST', json.encode({ username = "Nethush Logs",embeds = embedData}), { ['Content-Type'] = 'application/json' })
    Citizen.Wait(100)
    if tag then
