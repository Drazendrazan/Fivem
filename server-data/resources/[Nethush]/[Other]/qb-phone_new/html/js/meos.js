...
$(document).on('click', '.person-search-result', function(e){
    ...
    var OpenElement = '<div class="person-search-result-name">Name: '+ClickedPersonData.firstname+' '+ClickedPersonData.lastname+'</div> <div class="person-search-result-bsn">BSN: '+ClickedPersonData.citizenid+'</div> <div class="person-opensplit"></div> &nbsp; <div class="person-search-result-dob">Birthday: '+ClickedPersonData.birthdate+'</div> <div class="person-search-result-number">Telephone number: '+ClickedPersonData.phone+'</div> <div class="person-search-result-nationality">Nationality: '+ClickedPersonData.nationality+'</div> <div class="person-search-result-gender">Sex: '+Gender+'</div> &nbsp; <div class="person-search-result-apartment"><span id="'+ClickedPersonId+'">Appartement: '+appartementData.label+'</span> <i class="fas fa-map-marker-alt appartment-address-location" id="'+ClickedPersonId+'"></i></div> &nbsp; <div class="person-search-result-warned">Signed: '+IsWarrant+'</div> <div class="person-search-result-driverslicense">Drivers license: '+HasLicense+'</div>';
...
$(document).on('click', '.house-address-location', function(e){
    e.preventDefault();
...
$(document).on('click', '.appartment-address-location', function(e){
    e.preventDefault();
        ...
        $.post('http://qb-phone_new/FetchPlayerHouses', JSON.stringify({
            ...
            if (result != null) {
                ...
                $.each(result, function (i, house) {
                    var PersonElement = '<div class="person-search-result-house" id="personhouse-'+i+'"><div class="person-search-result-name">Owner: '+house.charinfo.firstname+' '+house.charinfo.lastname+'</div> <div class="person-search-result-bsn">Huis: '+house.label+'</div></div>';
                    $(".person-search-results").append(PersonElement);
