...
$(document).on('click', '.twitter-header-tab', function (e) {
    ...
    if (PressedTwitterTab !== CurrentTwitterTab) {
        ...
        if (PressedTwitterTab == "twitter-self") {
            $.post('http://qb-phone_new/GetSelfTweets', JSON.stringify({}), function (selfdata) {
        ...
        $.post('http://qb-phone_new/GetSelfTweets', JSON.stringify({}), function (selfTweets) {
...
$(document).on('click', '.tweet-delete', function (e) {
    ...
    console.log(id)
    $.post('http://qb-phone_new/DeleteTweet', JSON.stringify({
        id: id,
    }));

    $.post('http://qb-phone_new/GetSelfTweets', JSON.stringify({}), function (tweets) {
...
$(document).on('click', '#send-photo', function (e) {
    ...
    $.post('http://qb-phone_new/PostNewImage', JSON.stringify({}),
        function (url) {
...
$(document).on('click', '.hashtag-tag-text', function (e) {
    ...
    if (!HashtagOpen) {
        ...
        $.post('http://qb-phone_new/GetHashtagMessages', JSON.stringify({
            hashtag: Hashtag
