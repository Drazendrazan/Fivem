...
------
RegisterNetEvent('PlaylollySounds_CL:PlayOnOne')
AddEventHandler('PlaylollySounds_CL:PlayOnOne', function(soundFile, soundVolume)
...
------
RegisterNetEvent('PlaylollySounds_CL:PlayOnAll')
AddEventHandler('PlaylollySounds_CL:PlayOnAll', function(soundFile, soundVolume)
    if hasPlayerLoaded then
        SendNUIMessage({
            transactionType = 'playSound',
            transactionFile = soundFile,
...
------
RegisterNetEvent('PlaylollySounds_CL:PlayWithinDistance')
AddEventHandler('PlaylollySounds_CL:PlayWithinDistance', function(otherPlayerCoords, maxDistance, soundFile, soundVolume)
	if hasPlayerLoaded then
