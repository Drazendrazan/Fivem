                ...
                if dist < 10 then
                    ...
                    if dist < 1 then
                        ...
                        if IsControlJustPressed(0, Config.Keys["E"]) then
                            ...
                            ShopItems.slots = 30
                            TriggerServerEvent("nethush-inventory:server:OpenInventory", "shop", "Itemshop_"..shop, ShopItems)
                        end
                    end
                end
            end
...
Citizen.CreateThread(function()
    for store,_ in pairs(Config.Locations) do
		if Config.Locations[store]["products"] ~= Config.Products["black"] then
        ...
        elseif Config.Locations[store]["products"] == Config.Products["guruge"] then
