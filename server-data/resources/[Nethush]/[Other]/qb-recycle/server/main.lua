...
AddEventHandler("qb-recycle:server:getItem", function()
    ...
    for i = 1, math.random(1, 5), 1 do
        ...
        TriggerClientEvent('nethush-inventory:client:ItemBox', src, QBCore.Shared.Items[randItem], 'add')
        Citizen.Wait(500)
    end
    ...
    if Luck == Odd then
        ...
        TriggerClientEvent('nethush-inventory:client:ItemBox', src, QBCore.Shared.Items["rubber"], 'add')
    end
end)