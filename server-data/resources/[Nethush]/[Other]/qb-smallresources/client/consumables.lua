...
AddEventHandler("consumables:client:UseParachute", function()
    ...
    QBCore.Functions.Progressbar("use_parachute", "Hang the parachute..", 5000, false, true, {
        ...
        TriggerEvent("nethush-inventory:client:ItemBox", QBCore.Shared.Items["parachute"], "remove")
...
AddEventHandler("consumables:client:ResetParachute", function()
    if ParachuteEquiped then 
        ...
        QBCore.Functions.Progressbar("reset_parachute", "Pack parachute..", 40000, false, true, {
            ...
            local ped = GetPlayerPed(-1)
            TriggerEvent("nethush-inventory:client:ItemBox", QBCore.Shared.Items["parachute"], "add")
        ...
        TriggerEvent("swt_notifications:Infos","Je hebt geen parachute om!")
    end
end)
...
--         TriggerEvent("nethush-inventory:client:Itembox", QBCore.Shared.Items["smoketrailred"], "remove")
--     else
--         TriggerEvent("swt_notifications:Infos","Je moet een parachute om hebben om rook te activeren!")    
--     end
-- end)
...
AddEventHandler("consumables:client:UseArmor", function()
    QBCore.Functions.Progressbar("use_armor", "Put on the vest..", 5000, false, true, {
       ...
       -- TriggerServerEvent("police:server:SetHandcuffStatus", true)
        ...
        QBCore.Functions.TriggerCallback('Kingofnethush:armor', function(pamkya)
            if pamkya then
...
AddEventHandler("consumables:client:UseHeavyArmor", function()
    ...
    QBCore.Functions.TriggerCallback('Kingofnethush:harmor', function(slmc)
      if slmc then
        if PlayerData.charinfo.gender == 0 then
         ...
         TriggerEvent("nethush-inventory:client:ItemBox", QBCore.Shared.Items["heavyarmor"], "remove")
...
AddEventHandler("consumables:client:ResetArmor", function()
    ...
    if currentVest ~= nil and currentVestTexture ~= nil then 
        QBCore.Functions.Progressbar("remove_armor", "Removing vest..", 2500, false, true, {
            ...
            SetPedArmour(ped, 0)
            TriggerEvent("nethush-inventory:client:ItemBox", QBCore.Shared.Items["heavyarmor"], "add")
...
AddEventHandler("consumables:client:DrinkAlcohol", function(itemName)
    ...
    QBCore.Functions.Progressbar("snort_coke", "Consumming..", math.random(3000, 6000), false, true, {
        ...
        TriggerServerEvent("QBCore:Server:SetMetaData", "", QBCore.Functions.GetPlayerData().metadata["thirst"] + Consumeables[itemName])
        alcoholCount = alcoholCount + 1
...
AddEventHandler("consumables:client:Cokebaggy", function()
    QBCore.Functions.Progressbar("snort_coke", "Consumming..", math.random(5000, 8000), false, true, {
        ...
        TriggerEvent("nethush-inventory:client:ItemBox", QBCore.Shared.Items["cokebaggy"], "remove")
...
AddEventHandler("consumables:client:Crackbaggy", function()
    QBCore.Functions.Progressbar("snort_coke", "Consumming..", math.random(7000, 10000), false, true, {
        ...
        TriggerEvent("nethush-inventory:client:ItemBox", QBCore.Shared.Items["crack_baggy"], "remove")
...
AddEventHandler('consumables:client:EcstasyBaggy', function()
    QBCore.Functions.Progressbar("use_ecstasy", "Consumming", 3000, false, true, {
        ...
        TriggerEvent("nethush-inventory:client:ItemBox", QBCore.Shared.Items["xtcbaggy"], "remove")
        EcstasyEffect()
    end, function() -- Cancel
        StopAnimTask(GetPlayerPed(-1), "mp_suicide", "pill", 1.0)
        TriggerEvent("swt_notifications:Infos","Canceled")
