...
QBCore.Functions.CreateUseableItem("skateboard", function(source, item)
	...
	TriggerClientEvent('nethush-inventory:client:ItemBox', source, QBCore.Shared.Items["skateboard"], "remove")
...
AddEventHandler('skateboard:pick', function(item, amount)	
	...
	TriggerClientEvent('nethush-inventory:client:ItemBox', source, QBCore.Shared.Items["skateboard"], "add")
end)
