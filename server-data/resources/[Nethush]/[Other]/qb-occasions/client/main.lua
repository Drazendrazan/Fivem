...
RegisterNUICallback('error', function(data)
    TriggerEvent("swt_notifications:Infos","error")
end)
...
AddEventHandler('qb-occasions:client:BuyFinished', function(model, plate, mods)
    ...
    QBCore.Functions.SpawnVehicle(model, function(veh)
        ...
        TriggerEvent("swt_notifications:Infos","Vehicle bought")
...
AddEventHandler('qb-occasions:client:ReturnOwnedVehicle', function(vehdata)
    ...
    QBCore.Functions.SpawnVehicle(vehdata.model, function(veh)
        ...
        TaskWarpPedIntoVehicle(GetPlayerPed(-1), veh, -1)
        exports['esx_fuel']:SetFuel(veh, 100)
        TriggerEvent("swt_notifications:Infos","Your vehicle recieved ..")
...
function sellVehicleWait(price)
    ...
    Citizen.Wait(1500)
    DoScreenFadeIn(250)
    TriggerEvent('swt_notifications:Infos','Your car is for sale for €'..price..',-')
...
Citizen.CreateThread(function()
    ...
    AddTextComponentSubstringPlayerName("TripleCaution Car Sales")
