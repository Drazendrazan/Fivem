    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            if (data.toggle) {
                ...
                setTimeout(function(){
                    $.post('http://multiplecharacters/setupCharacters');
                    setTimeout(function(){
                        ...
                        $.post('http://multiplecharacters/removeBlur');
                    }, 200);
                }, 200);
            } else {
...
$('.disconnect-btn').click(function(e){
    ...
    $.post('http://multiplecharacters/closeUI');
    $.post('http://multiplecharacters/disconnectButton');
});
...
$(document).on('click', '.character', function(e) {
    ...
    if (selectedChar === null) {
        ...
        if ((selectedChar).data('cid') == "") {
            ...
            $.post('http://multiplecharacters/cDataPed', JSON.stringify({
                cData: cDataPed
            }));
        } else {
            $(selectedChar).addClass("char-selected");
...
$(document).on('click', '#create', function(e){
    e.preventDefault();
    $.post('http://multiplecharacters/createNewCharacter', JSON.stringify({
...
$(document).on('click', '#accept-delete', function(e){
    $.post('http://multiplecharacters/removeCharacter', JSON.stringify({
...
$(document).on('click', '#play', function(e) {
    ...
    if (selectedChar !== null) {
        if (charData !== "") {
            $.post('http://multiplecharacters/selectCharacter', JSON.stringify({
