...
RentVehicle = function(selectedVehicle)
    ...
    if IsPedInAnyVehicle(ped) then
        TriggerEvent('swt_notifications:Infos','this can only when not in a vehicle..')
        return
    end
...
ReturnVehicle = function()
    ...
    TriggerEvent('swt_notifications:Infos','You do not have a deposit open..')
end
...
AcceptReturn = function()
    ...
    if noSpace(VehiclePlate) ~= noSpace(RentedVehiclePlate) then
        TriggerEvent('swt_notifications:Infos','This is not a rental vehicle..')
    else
