...
RegisterNetEvent('nethush-assets:client:seat:shuffle')
AddEventHandler('nethush-assets:client:seat:shuffle', function()
...
RegisterNetEvent('nethush-assets:client:me:show')
AddEventHandler('nethush-assets:client:me:show', function(Text, Source)
...
RegisterNUICallback('CheckDevtools', function()
   TriggerServerEvent('nethush-assets:server:drop')
end)
