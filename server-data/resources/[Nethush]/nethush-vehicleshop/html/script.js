...
$(document).ready(function(){
    ...
    $('.vehicle-category').click(function(e){
        ...
        if (vehicleCategory == "home") {
            ...
            if ($('.vehicle-shop-home').css("display") !== "none") {
                $.post('http://nethush-vehicleshop/GetCategoryVehicles', JSON.stringify({
    ...
    $('.map-pin').click(function(e){
        ...
        $.post('http://nethush-vehicleshop/buyVehicle', JSON.stringify({
...
$(document).on('keydown', function() {
    switch(event.keyCode) {
        case 27: // ESC
            $.post('http://nethush-vehicleshop/exit')
            break;
    }
});