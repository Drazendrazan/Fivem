...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = {['cash'] = 50000, ['bank'] = 1000000, ['crypto'] = 0 } -- ['type']=startamount - Add or remove money types for your server (for ex. ['blackmoney']=0), remember once added it will not be removed from the database!
QBConfig.Money.DontAllowMinus = {'cash', 'crypto'} -- Money that is not allowed going in minus

QBConfig.Player = {}
QBConfig.Player.MaxWeight = 320000 -- Max weight a player can carry (currently 120kg, written in grams)
...
QBConfig.Server.discord = "https://discord.gg/jq9BGDpT" -- Discord invite link
