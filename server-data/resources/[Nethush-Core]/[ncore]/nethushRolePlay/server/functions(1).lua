QBCore.Functions = {}
QBCore.Functions.CancelledTimeouts    = {}
...
QBCore.Functions.SetTimeout = function(msec, cb)
	local id = QBCore.Functions.TimeoutCount + 1

	SetTimeout(msec, function()
		if QBCore.Functions.CancelledTimeouts[id] then
			QBCore.Functions.CancelledTimeouts[id] = nil
		else
			cb()
		end
	end)

	QBCore.Functions.TimeoutCount = id

	return id
end

QBCore.Functions.ClearTimeout = function(id)
	QBCore.Functions.CancelledTimeouts[id] = true
end
