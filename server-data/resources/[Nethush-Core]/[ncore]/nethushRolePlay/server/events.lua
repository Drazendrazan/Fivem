...
AddEventHandler('QBCore:UpdatePlayer', function(data)
	...
	if Player ~= nil then
		...
		local newHunger = Player.PlayerData.metadata["hunger"] - 10.2
		local newThirst = Player.PlayerData.metadata["thirst"] - 10.8
	...
	--	TriggerClientEvent('swt_notifications:Infos', src, "You received your paycheck of €"..Player.PlayerData.job.payment)
		TriggerClientEvent("swt_notifications:Info",src,"SLMC System","You received your paycheck of LKR"..Player.PlayerData.job.payment,"right",9000,true)
...
AddEventHandler('QBCore:ToggleDuty', function()
	...
	if Player.PlayerData.job.onduty then
		...
		--TriggerClientEvent('swt_notifications:Infos', src, "You are now off duty!")
		TriggerClientEvent("swt_notifications:Info",src,"SLMC System","You are now off duty!","top-right",6000,true)
	else
		Player.Functions.SetJobDuty(true)
		--TriggerClientEvent('swt_notifications:Infos', src, "You are now on duty!")
		TriggerClientEvent("swt_notifications:Info",src,"SLMC System","You are now on duty!","top-right",6000,true)
	end
