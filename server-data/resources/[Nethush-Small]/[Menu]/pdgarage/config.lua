...
Config.CarZones = {
	PoliceCarGarage = {
		Pos = {
			...
			{x = 1868.9716796875,  y = 3693.4318847656, z = 33.633220672607},
			{x = -467.33517456055,  y = 6015.90625, z = 31.340530395508}
...
Config.HeliZones = {
	PoliceHeliGarage = {
		Pos = {
			...
			{x = -475.77429199219,  y = 5988.05078125, z = 31.336681365967}
		}
	}
}
...
Config.PoliceVehicles = {
	{ model = '1200RT', label = 'BMW 1200RT', price = 0 },
	{ model = '2015polstang', label = 'Mustang GT 2015', price = 0 },
	{ model = 'code3camero', label = 'Code 3 Camero', price = 0 },
	{ model = 'code3cap', label = 'Code 3 Chevrolet', price = 0 },
	{ model = 'code3cvpi', label = 'Code 3 CVPI', price = 0 },
	{ model = 'code3durango', label = 'Code 3 Durango', price = 0 },
	{ model = 'code3f150', label = 'Code 3 F150', price = 0 },
	{ model = 'code3f250', label = 'Code 3 F250', price = 0 },
	{ model = 'code3fpis', label = 'Code 3 FPIS', price = 0 },
	{ model = 'code3mustang', label = 'Code 3 Mustang', price = 0 },
	{ model = 'code3ram', label = 'Code 3 Ram', price = 0 },
	{ model = 'code310charg', label = 'Code 3 Dodge Charger', price = 0 },
	{ model = 'code314charg', label = 'Code 3 Dodge Charger "14 ', price = 0 },
	{ model = 'code314tahoe', label = 'Code 3 Tahoe', price = 0 },
	{ model = 'code316fpiu', label = 'Code 3 FPIU', price = 0 },
	{ model = 'code316impala', label = 'Code 3 Impala', price = 0 },
	{ model = 'code318tahoe', label = 'Code 3 Tahoe "18', price = 0 },
	{ model = 'code319silv', label = 'Code 3 Silverado', price = 0 },
	{ model = 'code320exp', label = 'Code 3 EXP', price = 0 },
	{ model = 'bcsocharger', label = 'BCSO Charger', price = 0 },
	{ model = 'bcsocvpi', label = 'BCSO CVPI', price = 0 },
	{ model = 'bcsofpiu', label = 'BCSO FPIU', price = 0 },
	{ model = 'sh1', label = 'BCSO Charger "14', price = 0 },
	{ model = 'sh2', label = 'BCSO Tahoe', price = 0 },
	{ model = 'sh5', label = 'BCSO Charger "16', price = 0 },
	{ model = 'sh6', label = 'BCSO Charger "18', price = 0 },
	{ model = 'sh7', label = 'BCSO Silverado', price = 0 },
	{ model = 'code3trailer', label = 'Trailer Attachment', price = 0 }
...
Config.PoliceHelicopters = {
	...
	{ model = 'maverick2', label = 'Police State', livery = 0, price = 0 }
}
...
-- Commands:
Config.RepairCommand = 'fixp'
Config.CleanCommand = 'cleanp'
