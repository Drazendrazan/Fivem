Citizen.CreateThread(function()
	...
	local openMenu = function(namespace, name, data)
		for i=1, #Timeouts, 1 do
			QBCore.Functions.ClearTimeout(Timeouts[i])
		end
		...
		local timeoutId = QBCore.Functions.SetTimeout(200, function()
	...
	RegisterNUICallback('menu_submit', function(data, cb)
		...
		if menu.submit ~= nil then
			...
			if post then
				...
				TriggerEvent('swt_notifications:Infos','That input is invalid!')
			end
		end
