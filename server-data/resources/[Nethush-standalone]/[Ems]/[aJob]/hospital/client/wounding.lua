...
AddEventHandler('hospital:client:UseBandage', function()
    QBCore.Functions.Progressbar("use_bandage", "Using bandage..", 4000, false, true, {
        ...
        TriggerEvent("nethush-inventory:client:ItemBox", QBCore.Shared.Items["bandage"], "remove")
...
AddEventHandler('hospital:client:UsePainkillers', function()
    QBCore.Functions.Progressbar("use_bandage", "Take painkillers", 3000, false, true, {
        ...
        TriggerEvent("nethush-inventory:client:ItemBox", QBCore.Shared.Items["painkillers"], "remove")
        onPainKillers = true
