...
AddEventHandler('hospital:server:TreatWounds', function(playerId)
	...
	if Patient ~= nil then
		...
		elseif Player.PlayerData.job.name == "ambulance" or Player.PlayerData.job.name == "doctor" or Player.PlayerData.job.name == "ems2" then
...
AddEventHandler('hospital:server:SetDoctor', function()
	...
	for k, v in pairs(QBCore.Functions.GetPlayers()) do
        ...
        if Player ~= nil then 
            if (Player.PlayerData.job.name == "ambulance" or Player.PlayerData.job.name == "doctor" or Player.PlayerData.job.name == "ems2" or Player.PlayerData.job.name == "ems3" or Player.PlayerData.job.name == "ems4" or Player.PlayerData.job.name == "ems5" and Player.PlayerData.job.onduty) then
                amount = amount + 1
            end
        end
	end
...
AddEventHandler('hospital:server:RevivePlayer', function(playerId, isOldMan)
	...
	if Patient ~= nil then
		if oldMan then
			...
			--	TriggerClientEvent('swt_notifications:Infos', src, "You don't have enough money in your pocket..")
				TriggerClientEvent("swt_notifications:Warning",src,"SLMC System","You don't have enough money in your pocket..","top-right",6000,true)
...
AddEventHandler('hospital:server:SendDoctorAlert', function()
	...
	for k, v in pairs(QBCore.Functions.GetPlayers()) do
		local Player = QBCore.Functions.GetPlayer(v)
		if Player ~= nil then 
			if (Player.PlayerData.job.name == "ambulance" or Player.PlayerData.job.name == "doctor" or Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "ems3" or Player.PlayerData.job.name == "ems4" or Player.PlayerData.job.name == "ems5" or Player.PlayerData.job.name == "ems6" or Player.PlayerData.job.name == "ems7" or Player.PlayerData.job.name == "ems8" and Player.PlayerData.job.onduty) then
