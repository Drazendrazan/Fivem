...
AddEventHandler('police:server:BillPlayer', function(playerId, price)
    ...
    if Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "police1" or Player.PlayerData.job.name == "police2" or Player.PlayerData.job.name == "police3" or Player.PlayerData.job.name == "police4" or Player.PlayerData.job.name == "police5" or Player.PlayerData.job.name == "police6" or Player.PlayerData.job.name == "police7" or Player.PlayerData.job.name == "police8" then
        if OtherPlayer ~= nil then
            ...
            TriggerClientEvent('swt_notifications:Infos', OtherPlayer.PlayerData.source, "You received a fine from $"..price)
        end
    end
end)
...
AddEventHandler('police:server:JailPlayer', function(playerId, time)
    ...
    if Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "police1" or Player.PlayerData.job.name == "police2" or Player.PlayerData.job.name == "police3" or Player.PlayerData.job.name == "police4" or Player.PlayerData.job.name == "police5" or Player.PlayerData.job.name == "police6" or Player.PlayerData.job.name == "police7" or Player.PlayerData.job.name == "police8" then
        if OtherPlayer ~= nil then
            ...
            TriggerClientEvent('swt_notifications:Infos', src, "You sent the person to prison for "..time.." months")
        end
    end
end)
...
AddEventHandler('qb-police:server:send:alert:panic:button', function(Coords, StreetName, Info)
    ...
    TriggerClientEvent("police:client:PoliceEmergencyAlert", -1, Callsign, StreetName, Coords)
...
RegisterServerEvent('police:server:ArobCall')
AddEventHandler('police:server:ArobCall', function(coords, msg,streetLabel)
    local src = source
    local alertData = {
        title = "Atm Robbery Progress",
        coords = {x = coords.x, y = coords.y, z = coords.z},
        description = msg,
    }
    print(streetLabel)
    TriggerClientEvent("police:client:ArobCall", -1, coords, msg, streetLabel)
    TriggerClientEvent("qb-phone:client:addPoliceAlert", -1, alertData)
end)
...
AddEventHandler('police:server:SearchPlayer', function(playerId)
    ...
    if SearchedPlayer ~= nil then 
        ...
        TriggerClientEvent('swt_notifications:Infos', SearchedPlayer.PlayerData.source, "You are being searched..")
    end
end)
...
AddEventHandler('police:server:SeizeCash', function(playerId)
    ...
    if SearchedPlayer ~= nil then 
        ...
        TriggerClientEvent('nethush-inventory:client:ItemBox', src, QBCore.Shared.Items["moneybag"], "add")
        TriggerClientEvent('swt_notifications:Infos', SearchedPlayer.PlayerData.source, "Your cash confiscated..")
    end
end)
...
AddEventHandler('police:server:SeizeqbverLicense', function(playerId)
    ...
    if SearchedPlayer ~= nil then
        ...
        if qbverLicense then
            ...
            TriggerClientEvent('swt_notifications:Infos', SearchedPlayer.PlayerData.source, "Your qbving license confiscated..")
        else
            TriggerClientEvent('swt_notifications:Infos', src, "Can't take qbving license..")
        end
    end
end)
------------------------------------
...
RegisterServerEvent('qb-police:server:send:alert:yachtrob')
AddEventHandler('qb-police:server:send:alert:yachtrob', function(Coords, StreetName)
   local AlertData = {title = "Yacht Robbery", coords = {x = Coords.x, y = Coords.y, z = Coords.z}, description = "A Yacht Has Been Down at "..StreetName}
   TriggerClientEvent("qb-phone:client:addPoliceAlert", -1, AlertData)
   TriggerClientEvent('qb-police:client:send:alert:yachtrob', -1, Coords, StreetName)
end)

RegisterServerEvent('qb-police:server:send:alert:atmro')
AddEventHandler('qb-police:server:send:alert:atmro', function(Coords, StreetName)
   local AlertData = {title = "ATM Robbery", coords = {x = Coords.x, y = Coords.y, z = Coords.z}, description = "ATM Robbery at "..StreetName}
   TriggerClientEvent("qb-phone:client:addPoliceAlert", -1, AlertData)
   TriggerClientEvent('qb-police:client:send:alert:atmro', -1, Coords, StreetName)
end)

RegisterServerEvent('qb-police:server:send:alert:storerob')
AddEventHandler('qb-police:server:send:alert:storerob', function(Coords, StreetName)
   local AlertData = {title = "Store Robbery", coords = {x = Coords.x, y = Coords.y, z = Coords.z}, description = "Store Robbery at "..StreetName}
   TriggerClientEvent("qb-phone:client:addPoliceAlert", -1, AlertData)
   TriggerClientEvent('qb-police:client:send:alert:storerob', -1, Coords, StreetName)
end)

RegisterServerEvent('qb-police:server:send:alert:houser')
AddEventHandler('qb-police:server:send:alert:houser', function(Coords, StreetName)
   local AlertData = {title = "House Rob Alarm", coords = {x = Coords.x, y = Coords.y, z = Coords.z}, description = "A house alarm system has been triggered off at "..StreetName}
   TriggerClientEvent("qb-phone:client:addPoliceAlert", -1, AlertData)
   TriggerClientEvent('qb-police:client:send:alert:houser', -1, Coords, StreetName)
end)
...
AddEventHandler('police:server:RobPlayer', function(playerId)
    ...
    if SearchedPlayer ~= nil then 
        ...
        TriggerClientEvent('swt_notifications:Infos', SearchedPlayer.PlayerData.source, "You're like $"..money.." robbed")
    end
end)
...
AddEventHandler('police:server:Impound', function(plate, fullImpound, price)
    ...
    if IsVehicleOwned(plate) then
        if not fullImpound then
            ...
            TriggerClientEvent('swt_notifications:Infos', src, "Vehicle entered in depot before $"..price.."!")
        else
            exports['ghmattimysql']:execute('UPDATE player_vehicles SET state = @state WHERE plate = @plate', {['@state'] = 2, ['@plate'] = plate})
            TriggerClientEvent('swt_notifications:Infos', src, "Vehicle completely seized!")
        end
    end
end)
...
AddEventHandler('evidence:server:AddBlooddropToInventory', function(bloodId, bloodInfo)
    ...
    if Player.Functions.RemoveItem("empty_evidence_bag", 1) then
        if Player.Functions.AddItem("filled_evidence_bag", 1, false, bloodInfo) then
            TriggerClientEvent("nethush-inventory:client:ItemBox", src, QBCore.Shared.Items["filled_evidence_bag"], "add")
            TriggerClientEvent("evidence:client:RemoveBlooddrop", -1, bloodId)
            BloodDrops[bloodId] = nil
        end
    else
        TriggerClientEvent('swt_notifications:Infos', src, "You must have an empty evidence bag with you")
    end
end)
...
AddEventHandler('police:server:SetTracker', function(targetId)
    ...
    if TrackerMeta then
        ...
        TriggerClientEvent('swt_notifications:Infos', targetId, 'Your ankle strap is taken off.')
        TriggerClientEvent('swt_notifications:Infos', source, 'You took off an ankle bracelet from '..Target.PlayerData.charinfo.firstname.." "..Target.PlayerData.charinfo.lastname)
        TriggerClientEvent('police:client:SetTracker', targetId, false)
    else
        Target.Functions.SetMetaData("tracker", true)
        TriggerClientEvent('swt_notifications:Infos', targetId, 'You took off an ankle bracelet from')
        TriggerClientEvent('swt_notifications:Infos', source, 'You put on an ankle strap at'..Target.PlayerData.charinfo.firstname.." "..Target.PlayerData.charinfo.lastname)
...
QBCore.Commands.Add("flagplate", "Mark a vehicle", {{name="plate", help="License plate"}, {name =" reason ", help =" Reason for marking"}}, true, function(source, args)
    ...
    if Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "police1" or Player.PlayerData.job.name == "police2" or Player.PlayerData.job.name == "police3" or Player.PlayerData.job.name == "police4" or Player.PlayerData.job.name == "police5" or Player.PlayerData.job.name == "police6" or Player.PlayerData.job.name == "police7" or Player.PlayerData.job.name == "police8" then
        ...
        TriggerClientEvent('swt_notifications:Infos', source, "Vehicle ("..args[1]:upper()..") is marked for: "..table.concat(reason, " "))
    else
        TriggerClientEvent('chatMessage', source, "SYSTEM", "error", "This command is for emergency services!")
    end
end)
    ...
    if Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "police1" or Player.PlayerData.job.name == "police2" or Player.PlayerData.job.name == "police3" or Player.PlayerData.job.name == "police4" or Player.PlayerData.job.name == "police5" or Player.PlayerData.job.name == "police6" or Player.PlayerData.job.name == "police7" or Player.PlayerData.job.name == "police8" then
        if Plates ~= nil and Plates[args[1]:upper()] ~= nil then
            if Plates[args[1]:upper()].isflagged then
                ...
                TriggerClientEvent('swt_notifications:Infos', source, "Vehicle ("..args[1]:upper()..") is no longer marked")
            else
    ...
    if Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "police1" or Player.PlayerData.job.name == "police2" or Player.PlayerData.job.name == "police3" or Player.PlayerData.job.name == "police4" or Player.PlayerData.job.name == "police5" or Player.PlayerData.job.name == "police6" or Player.PlayerData.job.name == "police7" or Player.PlayerData.job.name == "police8" or Player.PlayerData.job.name == "ambulance" then
        ...
        if OtherPlayer ~= nil then
            if OtherPlayer.PlayerData.job.name == "tow" then
                ...
                TriggerClientEvent('swt_notifications:Infos', source, 'You paid a mountain net employee')
            else
                TriggerClientEvent('swt_notifications:Infos', source, 'Person is not a mountain net employee')
            end
        end
    else
        TriggerClientEvent('chatMessage', source, "SYSTEM", "error", "This command is for emergency services!")
    ...
    if Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "police1" or Player.PlayerData.job.name == "police2" or Player.PlayerData.job.name == "police3" or Player.PlayerData.job.name == "police4" or Player.PlayerData.job.name == "police5" or Player.PlayerData.job.name == "police6" or Player.PlayerData.job.name == "police7" or Player.PlayerData.job.name == "police8" or Player.PlayerData.job.name == "judge" then
        ...
        if OtherPlayer ~= nil then
            if OtherPlayer.PlayerData.job.name == "lawyer" then
                ...
                TriggerClientEvent('swt_notifications:Infos', source, 'You paid a lawyer')
            else
                TriggerClientEvent('swt_notifications:Infos', source, 'Person is not a lawyer')
            end
        end
    else
        TriggerClientEvent('chatMessage', source, "SYSTEM", "error", "This command is for emergency services!")
...
QBCore.Commands.Add("911", "Send a report to emergency services", {{name="Message", help="Message you want to send to the emergency services"}}, true, function(source, args)
    ...
    if Player.Functions.GetItemByName("phone") ~= nil then
       ...
       -- TriggerClientEvent("hospital:server:SendDoctorAlert")
        ...
        TriggerClientEvent('swt_notifications:Infos', source, 'You dont have a phone')
    end
end)
...
QBCore.Commands.Add("911r", "Send a Message back to a report", {{name="id", help="ID of the report"}, {name="Message", help="Message you want to send"}}, true, function(source, args)
    ...
    local message = table.concat(args, " ")
    local Prefix = "POLICE"
    if (Player.PlayerData.job.name == "ambulance" or Player.PlayerData.job.name == "doctor" or Player.PlayerData.job.name == "ems2" or Player.PlayerData.job.name == "ems3" or Player.PlayerData.job.name == "ems4" or Player.PlayerData.job.name == "ems5" or Player.PlayerData.job.name == "ems6" or Player.PlayerData.job.name == "ems7" or Player.PlayerData.job.name == "ems8") then
        Prefix = "AMBULANCE"
    end
    if OtherPlayer ~= nil then 
        ...
        if args[1] ~= nil then
            ...
            if Target ~= nil then
                if Target.PlayerData.metadata["tracker"] then
                    ...
                    TriggerClientEvent('swt_notifications:Infos', source, 'This person has no ankle strap.')
                end
            end
        end
    else
    ...
    if ((Player.PlayerData.job.name == "police" or Player.PlayerData.job.name == "police1" or Player.PlayerData.job.name == "police2" or Player.PlayerData.job.name == "police3" or Player.PlayerData.job.name == "police4" or Player.PlayerData.job.name == "police5" or Player.PlayerData.job.name == "police6" or Player.PlayerData.job.name == "police7" or Player.PlayerData.job.name == "police8") and Player.PlayerData.job.onduty) and OtherPlayer ~= nil then
        if Player.Functions.RemoveItem("empty_evidence_bag", 1) then
            ...
            if Player.Functions.AddItem("filled_evidence_bag", 1, false, info) then
                TriggerClientEvent("nethush-inventory:client:ItemBox", source, QBCore.Shared.Items["filled_evidence_bag"], "add")
            end
        else
            TriggerClientEvent('swt_notifications:Infos', source, "You must have an empty evidence bag with you")
        end
    end
end)
...
RegisterServerEvent('nethush-police:server:escort:closest')
AddEventHandler('nethush-police:server:escort:closest', function(SeverId)
    local Player = QBCore.Functions.GetPlayer(source)
    local EscortPlayer = QBCore.Functions.GetPlayer(SeverId)
    if EscortPlayer ~= nil then
        if (EscortPlayer.PlayerData.metadata["ishandcuffed"] or EscortPlayer.PlayerData.metadata["isdead"]) then
            TriggerClientEvent("nethush-police:client:get:escorted", EscortPlayer.PlayerData.source, Player.PlayerData.source)
        else
...
RegisterServerEvent('nethush-police:server:set:out:veh')
AddEventHandler('nethush-police:server:set:out:veh', function(ServerId)
    local Player = QBCore.Functions.GetPlayer(source)
    local EscortPlayer = QBCore.Functions.GetPlayer(ServerId)
    if EscortPlayer ~= nil then
        if EscortPlayer.PlayerData.metadata["ishandcuffed"] or EscortPlayer.PlayerData.metadata["isdead"] then
            TriggerClientEvent("nethush-police:client:set:out:veh", EscortPlayer.PlayerData.source)
        else
            TriggerClientEvent('chatMessage', source, "SYSTEM", "error", "Person is not dead or handcuffed!")
        end
    end
...
RegisterServerEvent('nethush-police:server:set:in:veh')
AddEventHandler('nethush-police:server:set:in:veh', function(ServerId)
    local Player = QBCore.Functions.GetPlayer(source)
    local EscortPlayer = QBCore.Functions.GetPlayer(ServerId)
    if EscortPlayer ~= nil then
        if EscortPlayer.PlayerData.metadata["ishandcuffed"] or EscortPlayer.PlayerData.metadata["isdead"] then
            TriggerClientEvent("nethush-police:client:set:in:veh", EscortPlayer.PlayerData.source)
        else
            TriggerClientEvent('chatMessage', source, "SYSTEM", "error", "Person is not dead or handcuffed!")
        end
    end
