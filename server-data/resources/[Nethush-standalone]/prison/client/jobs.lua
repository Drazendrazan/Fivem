...
function JobDone()
    if math.random(1, 100) <= 50 then
        TriggerEvent("swt_notifications:Infos","You've worked some time off your sentence")
...
function CreateJobBlip()
    if currentLocation ~= 0 then
        ...
        if Chance == Odd then
            ...
            TriggerEvent('nethush-inventory:client:ItemBox', QBCore.Shared.Items["phone"], "add")
            TriggerEvent("swt_notifications:Infos","You found a phone..")
        end
    end
end