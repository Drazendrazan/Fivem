...
function CleanVehicle(vehicle)
	...
	QBCore.Functions.Progressbar("repair_vehicle", "Cleaning yeet vehicle...", math.random(10000, 20000), false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
	}, {}, {}, {}, function() -- Done
		TriggerEvent("DoShortHudText", "Vehicle cleaned!")
...
function RepairVehicleFull(vehicle)
	...
	QBCore.Functions.Progressbar("repair_vehicle", "Repairing vehicle..", math.random(20000, 30000), false, true, {
		...
		TriggerEvent("DoShortHudText", "Vehicle repaired!")
...
local function notification(msg)
	TriggerEvent("DoShortHudText", (msg))
end
